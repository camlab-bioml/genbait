...
def run_lasso(df_norm, k=None, seed=4):
    """
    Perform feature selection using Lasso and return the top-k selected baits.
    ...
    model = LogisticRegression(penalty='l1', solver='saga', random_state=46)
